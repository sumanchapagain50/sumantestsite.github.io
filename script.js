...
const rotateHorizontalBtn = document.getElementById('rotate-horizontal');
const rotateVerticalBtn = document.getElementById('rotate-vertical');
...
const floodActions = {
  Mitigation: [
    { text: "Construct levees", point: 9 },
    { text: "Improve drainage", point: 8 },
    { text: "Elevate homes", point: 8 },
    { text: "Rainwater harvesting", point: 1 },
    { text: "Permeable pavements", point: 4 },
    { text: "River widening", point: 10 },
    { text: "Dike reinforcement", point: 9 },
    { text: "Green infrastructure", point: 8 },
    { text: "Plant trees", point: 6 },
    { text: "Early warning systems", point: 5 },
    { text: "Flood zoning", point: 10 },
    { text: "Risk mapping", point: 7 },
    { text: "Retaining walls", point: 10 },
    { text: "Buffer zones", point: 7 },
    { text: "Check dams", point: 10 }
  ],
  Vulnerability: [
    { text: "Low-income areas", point: 7 },
    { text: "Informal settlements", point: 8 },
    { text: "No insurance", point: 9 },
    { text: "Elderly population", point: 10 },
    { text: "Children in school", point: 9 },
    { text: "Disabled people", point: 10 },
    { text: "Marginalized groups", point: 8 },
    { text: "Lack of documents", point: 6 },
    { text: "Poor housing", point: 9 },
    { text: "Riverbank dwellers", point: 10 },
    { text: "Tenants", point: 4 },
    { text: "Isolated villages", point: 4 },
    { text: "Women-headed households", point: 6 },
    { text: "No savings", point: 6 },
    { text: "Migrants", point: 5 }
  ],
  Capacity: [
    { text: "Boats", point: 10 },
    { text: "First aid kits", point: 7 },
    { text: "Life jackets", point: 10 },
    { text: "Rescue teams", point: 10 },
    { text: "Food stockpiles", point: 7 },
    { text: "Rescue drills", point: 6 },
    { text: "Community radios", point: 5 },
    { text: "Power backup", point: 5 },
    { text: "Inflatable rafts", point: 10 },
    { text: "Water purifiers", point: 5 },
    { text: "Flashlights", point: 5 },
    { text: "Evacuation ladders", point: 9 },
    { text: "Emergency response teams", point: 9 },
    { text: "Sandbags", point: 4 },
    { text: "Generators", point: 5 }
  ],
  Preparedness: [
    { text: "Evacuation plans", point: 10 },
    { text: "Mock drills", point: 10 },
    { text: "Community groups", point: 9 },
    { text: "Flood awareness", point: 10 },
    { text: "School education", point: 9 },
    { text: "SMS alerts", point: 7 },
    { text: "Volunteer training", point: 9 },
    { text: "Hazard boards", point: 8 },
    { text: "Emergency contact list", point: 6 },
    { text: "Family preparedness", point: 9 },
    { text: "Risk communication", point: 8 },
    { text: "Early alert signs", point: 9 },
    { text: "Safe routes", point: 8 },
    { text: "Flood drills", point: 10 },
    { text: "Assembly points", point: 8 }
  ],
  Response: [
    { text: "Immediate rescue", point: 10 },
    { text: "Temporary shelter", point: 9 },
    { text: "Medical aid", point: 9 },
    { text: "Food distribution", point: 9 },
...
const actionDescriptions = {
  ...
  "First aid kits": "First aid kits provide immediate medical supportcea for injuries during flood emergencies.",
...
function resetCube() {
  resetBtn.click(); // Trigger the reset button's click event
}
...
function populateCube() {
  ...
  for (const face of Object.keys(faceTitles)) {
    ...
    tilesData.forEach(({ text }, index) => {
      ...
      if (gameStarted && text && !gameSubmitted) {
...
function enableTileEvents() {
  ...
  tiles.forEach(tile => {
    // Mouse-based single click for description and selection
    tile.onclick = (e) => {
    ...
    // Touch-based single tap for description and selection
...
submitBtn.onclick = () => {
  ...
  gameSubmitted = true; // Set flag to prevent further tile interactions
  ...
  splashScreen.innerHTML = `
    <div>Your Score: ${totalPoints}</div>
    <button id="close-splash">Close</button>
  `;
  ...
  // Close splash screen on button click
  ...
  cube.querySelectorAll('.tile').forEach(tile => {
    ...
    tile.classList.remove('draggable', 'selected');
    tile.style.cursor = 'not-allowed';
    tile.onclick = null; // Remove click event
    tile.ontouchstart = null; // Remove touch event
  });

  // Disable drop box interactions
  dropBoxes.forEach(box => {
    box.ondragover = (e) => e.preventDefault();
    box.ondrop = (e) => e.preventDefault();
    box.onclick = null; // Remove click event
    box.ontouchstart = null; // Remove touch event
    box.style.cursor = 'default';
  });

  // Disable dropped tile interactions
  document.querySelectorAll('.dropped-tile').forEach(tile => {
    tile.onclick = null; // Prevent returning tiles to cube
  });
  ...
  // Ensure rotate buttons remain enabled
...
function startGame() {
  gameStarted = true;
  gameSubmitted = false; // Reset submission flag
...
resetBtn.onclick = () => {
  ...
  // Ensure rotate buttons are enabled
  rotateHorizontalBtn.disabled = false;
  rotateVerticalBtn.disabled = false;
};
...
hamburgerToggle.onclick = () => {
  ...
  if (voiceToggle.checked) {
    ...
    speak(isCollapsed ? 'Sidebar collapsed' : 'Sidebar expanded');
  }
};
